...
interface SidebarContext {
  ...
  isMobile: boolean;
  toggleSidebar: () => void;
  openConfigSidebar: (content: any) => void | undefined;
}
...
const SidebarProvider = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    ...
    openConfigSidebar?: (content: any) => void;
  }
>(
  (
    {
    ...
    const contextValue = React.useMemo<SidebarContext>(
      () => ({
        ...
        setOpenMobile,
        toggleSidebar,
        openConfigSidebar: openConfigSidebar as any, // Explicitly assert the type
      }),
      [
        state,
        open,
...
const SidebarGroupAction = React.forwardRef<
  HTMLButtonElement, // If using Slot, it can be a div or button
