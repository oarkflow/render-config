      ...
      const resolveItems = async () => {
        ...
        if (
          ...
          try {
            ...
            console.log(content, "content to show in unordered list");
            
            // Extract data using field name if available
            let dataToUse = content;
            if (items?.fieldName && typeof content === 'object' && content !== null) {
              ...
              let current: any = content; // Start with the content object
      ...
      <>
        {showWebBuilderInfo && (
          <div className="p-2 border border-dashed border-gray-300 rounded">
            <p className="text-sm font-medium">Unordered List (API Source)</p>
...
UnorderedList.displayName = "Unordered List";
